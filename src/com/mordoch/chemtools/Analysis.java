 ...
 * <p><em>All methods are static; this class is abstract.</em></p>
...
public abstract class Analysis {
	 ...
	 * @param molarMass1 molar mass of the first element in compound X
	 * @param molarMass2 molar mass of the second element in compound X
	 * @param molarMass3 molar mass of the third element in compound X
	...
	public static String empiricalFromPercentComposition (double percent1, double percent2, double percent3, double molarMass1, double molarMass2, double molarMass3, String element1, String element2, String element3) {
		// First find the mols of each element then find which one is smallest.
		double element1Mols = percent1 / molarMass1;
		double element2Mols = percent2 / molarMass2;
		double element3Mols = percent3 / molarMass3;
	...
	public static String empiricalFromPercentComposition (double percent1, double percent2, double molarMass1, double molarMass2, String element1, String element2) {
		// First find the mols of each element then find which one is smallest.
		double element1Mols = percent1 / molarMass1;
		double element2Mols = percent2 / molarMass2;
	...
	public static String empiricalFromMass (double mass1, double mass2, double mass3, double molarMass1, double molarMass2, double molarMass3, String element1, String element2, String element3) {
		// First find the perccent composition
		double element1Percent = mass1 / molarMass1;
		double element2Percent = mass2 / molarMass2;
		double element3Percent = mass3/ molarMass3;
		// Now find empirical formula (there's already a method for this, so why not?).
		return Analysis.empiricalFromPercentComposition(element1Percent, element2Percent, element3Percent, molarMass1, molarMass2, molarMass3, element1, element2, element3);
	}
	...
	public static String empiricalFromMass (double mass1, double mass2, double molarMass1, double molarMass2, String element1, String element2) {
		// First find the percent composition
		double element1Percent = mass1 / molarMass1;
		double element2Percent = mass2 / molarMass2;
		// Now find empirical formula
		return Analysis.empiricalFromPercentComposition(element1Percent, element2Percent, molarMass1, molarMass2, element1, element2);
	}
	 ...
	 * It returns the subscripts of the molecular formula.
	...
	public static int[] molecularFromEmpirical (double molarMassCompound, double molarMassEmpirical, int[] subscripts) {
